...
!!! note "The outcome expectations"

    Real-time availability of classifications per trauma case.
...
!!! note "Hence the underlying aims are"
    ...
    The automatic classification of trauma case text pieces; objective &#8594;
