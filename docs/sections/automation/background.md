...
<ol>
  <li>A <a href="https://github.com/excomputing/data" target="_blank">one-off solution</a> that sets up a data depository within Amazon, and subsequently delivers historical Scottish Air Quality nitrogen dioxide data to the depository; after inspecting and structuring. </li>
